...
//   };
  ...
  useEffect(() => {
    ...
    //   );
        ...
        if(formData.other!==""&&Object.keys(formErrors).includes("product_name","height","breadth","Length")){
            console.log(formData);
            console.log("form submitted")
            navigate("/success");
        }
        
        else if (Object.keys(formErrors).includes("other")&&formData.product_name!=="" &&formData.height!=="" &&formData.breadth!==""&&formData.Length!=="" && isSubmit) {
          console.log(formData);
